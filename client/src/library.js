...
export function decPlaces2HoursToTime(decimalHours) {
...
export function floatHoursToTime(floatHours) {
...
export function timeToFloatHours(time) {
...
export function onlyFloatToDecPlaces2(number) {
